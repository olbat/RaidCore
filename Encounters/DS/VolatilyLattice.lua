...
function mod:OnChatDC(message)
    ...
    elseif message == self.L["Avatus prepares to delete all"] then
        core:AddMsg("PILLAR_TIMEOUT", "PILLAR TIMEOUT", 5, mod:GetSetting("SoundBigCast") and "Beware")
    ...
    elseif message == self.L["Secure Sector Enhancement"] then
        core:AddMsg("P2", "P2: SHIELD PHASE", 5, mod:GetSetting("SoundShieldPhase") and "Alert")
    ...
    elseif message == self.L["Vertical Locomotion Enhancement"] then
        core:AddMsg("P2", "P2: JUMP PHASE", 5, mod:GetSetting("SoundJumpPhase") and "Alert")
