...
local msgStrings = {
	...
	["frFR"] = {
		module = "",	-- !!! "Module %s loaded"
		unitName = "Ohmna la Terriphage",
		unitNameTentacle = "Tentacule d'Ohmna",
		unitNameMaw = "Gueule vorace de la Terriphage",
		tentacleWarn = "Tentacule",
		tentacleBar = "",	-- !!! "Next Tentacles"
		p2SoonWarn = "",	-- !!! "P2 SOON !"
		p3SoonWarn = "",	-- !!! "P3 SOON !"
		p3Warn = "",	-- !!! "P3 REALLY SOON !"
