...
mod:RegisterEnableBossPair("Megalith", "Mnémésis") -- Mnemesis
...
function mod:OnSpellCastStart(unitName, castName, unit)
	if unitName == "Mnémésis" and castName == "Défragmentation" then -- Mnemesis, Defragment
...
function mod:OnCombatStateChanged(unit, bInCombat)
	if unit:GetType() == "NonPlayer" and bInCombat then
		...
		elseif sName == "Mnémésis" then -- Mnemesis
			...
			Apollo.RegisterEventHandler("UnitCreated", 			"OnUnitCreated", self)
			core:StartScan()
		elseif sName == "Matrice cristalline" then -- Crystalline Matrix
	...
	elseif unit:GetType() == "NonPlayer" and not bInCombat then
		local sName = unit:GetName()
		if sName == "Mnémésis" then -- Mnemesis
