...
local msgStrings = {
	...
	["frFR"] = {
		moduleName = "",	-- !!! "Module %s loaded"
		unitNameGolgox = "Golgox le Fossoyeur",
		unitNameTerax = "Terax Tisserouille",
		unitNameErsoth = "Ersoth le Maudisseur",
		unitNameNoxmind = "Toxultime l'Insidieux",
		unitNameFleshmonger = "Vratorg le Cannibale",
		teleportCast = "Se téléporter",
		iaWarn = "",	-- !!! "P2 : 20 IA"
		iaBar = "",	-- !!! "P2 : 20 IA"
		addsWarn = "",	-- !!! "P2 : MINI ADDS"
		addsBar = "",	-- !!! "P2 : MINI ADDS"
		...
		shieldWarn = "",	-- !!! "P2 : SHIELD"
		shieldBar = "",	-- !!! "P2 : SHIELD"
		energyCast = "Canalisation d'énergie",
		p2Bar = "",	-- !!! "[%s] NEXT P2"
		powerMsg = "",			-- !!! "The Phageborn Convergence begins gathering its power"
	},
	["deDE"] = {
