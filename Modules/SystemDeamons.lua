...
function mod:OnUnitCreated(unit)
	...
	elseif sName == "Wiederherstellungsprotokoll" then -- "Recovery Protocol"
		core:WatchUnit(unit)
	end
end
...
function mod:OnSpellCastEnd(unitName, castName, unit)
	if unitName == "Wiederherstellungsprotokoll" and castName == "Reparatursequenz" then -- "Recovery Protocol", "Repair Sequence"
...
function mod:OnSpellCastStart(unitName, castName, unit)
	if unitName == "Binärsystem-Dämon" and castName == "Kraft der Brandung" then -- "Binary System Daemon", "Power Surge"
	...
	elseif unitName == "Nullsystem-Dämon" and castName == "Kraft der Brandung" then -- "Null System Daemon", "Power Surge"
	...
	elseif unitName == "Wiederherstellungsprotokoll" and castName == "Reparatursequenz" then -- "Recovery Protocol", "Repair Sequence"
...
function mod:OnDebuffApplied(unitName, splId, unit)
	...
	if strSpellName == "Überlasten" then -- "Overload"
		core:MarkUnit(unit, nil, "DOT DMG")
	elseif strSpellName == "Säubern" then -- "Purge"
...
function mod:OnZoneChanged(zoneId, zoneName)
	if zoneName == "Datenzone" then -- "Datascape"
		return
