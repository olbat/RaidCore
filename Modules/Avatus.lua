...
function mod:OnUnitCreated(unit)
	...
	elseif sName == "Holohand" then -- Holo Hand
	...
	elseif sName == "Mobius Physikkonstrukteur" then -- Mobius Physics Constructor
		core:AddUnit(unit)
		core:WatchUnit(unit)
		local unitId = unit:GetId()
		if unitId then
	...
	elseif sName == "Unaufhaltbare Objektsimulation" then -- Unstoppable Object Simulation
		core:AddUnit(unit)
	elseif sName == "Holokanone" then -- Holo Cannon
		core:AddPixie(unit:GetId(), 2, unit, nil, "Blue", 5, 100, 0)
	elseif sName == "Schocksphäre" then -- Shock Sphere
		core:AddPixie(unit:GetId(), 2, unit, nil, "Blue", 5, -7, 0)
	elseif sName == "Hilfskanone" then -- Support Cannon
		core:AddUnit(unit)
	end

	-- TESTING BLUE ROOM:
	if sName == "Unendliche Logikschleife" then -- Infinite Logic Loop
		core:AddUnit(unit)
		core:UnitBuff(unit)
...
function mod:OnUnitDestroyed(unit)
	...
	if sName == "Holohand" then -- Holo Hand
		if unitId then
	...
	elseif sName == "Schocksphäre" then -- Shock Sphere
		core:DropPixie(unit:GetId())
	elseif sName == "Unendliche Logikschleife" then -- Infinite Logic Loop
...
function mod:OnBuffApplied(unitName, splId, unit)
	...
	if phase2_blueroom and unitName == "Infinite Logic Loop" then
		...
		if strSpellName == "Grüne Wiederherstellungsmatrix" then -- Green Reconstitution Matrix
		...
		elseif strSpellName == "Blaue Unterbrechungsmatrix" then -- Blue Disruption Matrix
			...
			if not buffCountTimer then buffCountTimer = true self:ScheduleTimer("ResetBuffCount", 13) end
		elseif strSpellName == "Rote Ermächtigungsmatrix" then -- Red Empowerment Matrix
...
function mod:OnSpellCastStart(unitName, castName, unit)
	local eventTime = GameLib.GetGameTime()
	if unitName == "Avatus" and castName == "Vernichtungsstrahl" then -- Avatus, Obliteration Beam
	...
	elseif unitName == "Holohand" and castName == "Vernichtender Schlag" then -- Holo Hand, Crushing Blow
	...
	elseif unitName == "Mobius Physikkonstrukteur" and castName == "Daten-Leuchtsignal" then -- Mobius Physics Constructor, Data Flare
